...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `𝐘𝐀𝐄 𝐌𝐚𝐧𝐨 @${num.split('@')[0]}\nBem vindo (𝐀) ao grupo *${mdata.subject}* para as lista do RPG mande oi,opa,ficha e lista bom rpg pra você e siba as regras Karay`
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛RLX AE MANO TO FAZENDO O BAGUIO AQ🤯⌛',
				success: '✔️Sucesso✔️',
			...
			const ownerNumber = ["554899800662@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '554899800662@s.whatsapp.net'
                        /******ApiKey Input******/
